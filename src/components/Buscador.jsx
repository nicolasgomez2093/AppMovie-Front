...
const Busqueda = () => {
    ...
    const { buscador, handleBuscador, peliculas, handlePeliculaId } = usePelicula();
  
  const peliculasFiltradas =
    busqueda === ""
      ? []
      : peliculas.filter((pelicula) =>
          pelicula.show.name.toLowerCase().includes(busqueda.toLowerCase())
        );
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div className="relative bg-white border rounded-lg p-5">
              <Combobox.Input
